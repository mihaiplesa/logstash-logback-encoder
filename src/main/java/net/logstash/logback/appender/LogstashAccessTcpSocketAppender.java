 ...
 */
public class LogstashAccessTcpSocketAppender extends AppenderBase<IAccessEvent>
    ...
    private BlockingQueue<IAccessEvent> queue;
     ...
     */
    protected Encoder<IAccessEvent> encoder;

    /**
     * @return the encoder
     */
    public Encoder<IAccessEvent> getEncoder() {
        return encoder;
    }
    ...
    public void start() {
        ...
        if (errorCount == 0) {
            encoder.start();
            queue = new LinkedBlockingQueue<IAccessEvent>(queueSize);
